...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:DropDownList ID="CommunitiesDropDownList" runat="server" AutoPostBack="true" ViewStateMode="Enabled" OnSelectedIndexChanged="CommunitiesDropDownList_SelectedIndexChanged">
            <asp:ListItem></asp:ListItem>
        </asp:DropDownList>


        <div class="WillNotBeVisibleUntilListIsSelected">
